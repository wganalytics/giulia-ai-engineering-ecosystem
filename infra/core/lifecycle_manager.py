...
Uso:
    python3 lifecycle_manager.py start-project GARE-88
    python3 lifecycle_manager.py start-task GARE-89
    python3 lifecycle_manager.py start-subtask GARE-96
    python3 lifecycle_manager.py complete GARE-89 --nota "Texto técnico..."
    python3 lifecycle_manager.py status GARE-88
"""
