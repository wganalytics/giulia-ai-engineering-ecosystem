...
REGISTRY_PATH = ROOT_DIR / "shared" / "REGISTRY" / "projects.json"
DIARY_PATH = ROOT_DIR / "governance" / "operational-memory" / "diario_de_bordo.md"
METRICS_PATH = ROOT_DIR / "observability" / "logs" / "rag_metrics.json"
...
3. **Snapshot Desatualizado**: Rodar `python ecosystem/automation/governance_snapshot.py {self.project_id}`.
